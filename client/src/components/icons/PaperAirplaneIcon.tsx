...
interface PaperAirplaneIconProps extends SVGProps<SVGSVGElement> {}

const PaperAirplaneIcon = ({ ...props }: PaperAirplaneIconProps) => {
  return (
    <svg aria-label="Direct" fill="currentColor" role="img" viewBox="0 0 24 24" {...props}>
      <title>Direct</title>
      <path
